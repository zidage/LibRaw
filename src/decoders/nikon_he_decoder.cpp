...
void LibRaw::nikon_he_load_raw()
{
    ...
    // Both HE (Bp ∈ {4,5}) and HE* (Bp ∈ {1,2,3,4}) share the JPEG-XS
    // SOC marker and route here. The decoder's gtli table
    // (nikon_he_gtli_table.cpp) covers HE*'s Bp regime directly and via
